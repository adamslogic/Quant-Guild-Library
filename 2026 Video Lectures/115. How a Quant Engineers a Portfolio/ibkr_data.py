"""
Fetch daily OHLCV from IBKR for portfolio symbols and merge into one CSV by date.
...
SYMBOLS = ("SPY", "SSO", "KMLM", "MNA", "RNR", "GLD", "FLSP")
...
OUTPUT_CSV = SCRIPT_DIR / "portfolio_prices.csv"
...
def fetch_and_save(
    ...
    try:
        for i, symbol in enumerate(SYMBOLS, start=1):
            ...
            df = fetch_daily_bars(app, req_id=i, symbol=symbol, duration_str=duration_str)
            if df.empty:
